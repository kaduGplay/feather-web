...
export function ServiceCreateForm() {
  ...
  async function onSubmit({
    ...
    await apiClient
      ...
      .then(response => {
        toast.success('O serviço foi criado com sucesso!');

        window.location.href = `/admin/services/${response.data.id}`;
      })
      .catch(error => {
  ...
  return (
    <div className="lg:w-[800px] mx-auto bg-gray-200 dark:bg-dark-100 p-2 rounded-md">
      <Container>
        <h1 className="text-[22px] font-semibold my-8">Criando serviço</h1>
