...
export function Coupon({ id }: { id: string }) {
  ...
  async function onSubmit({
    ...
    await apiClient
      ...
      .then(response => {
        toast.success('O cupom foi atualizado com sucesso!');
  ...
  async function getCoupon() {
    await apiClient
      ...
      .then(response => {
        ...
        setValue('is_recurrent', response.data.is_recurrent);
  ...
  return (
    <div className="lg:w-[800px] mx-auto bg-gray-200 dark:bg-dark-100 p-2 rounded-md">
      <Container>
        <h1 className="text-[22px] font-semibold my-8">Editando cupom</h1>
